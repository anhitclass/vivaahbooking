...
<section>
    <div class="our-services1" id="couple">
      <div class="content">
          ...
          <div class="card1">
            <img class="img-fluid" src="images/fireworks.jpg" alt="Bride">
        ...
        <div class="card1">
          <img class="img-fluid" src="images/music.jpg" alt="Bride">
          <h3 class="title"> Music (Dj and Baggi)</h3>
          <div class="social-links">
            <a class="btn btn-link" href="#"><i class="fab fa-facebook-f" aria-hidden="true"></i></a>
            <a class="btn btn-link" href="#"><i class="fab fa-twitter" aria-hidden="true"></i></a>
            <a class="btn btn-link" href="#"><i class="fab fa-google-plus-g" aria-hidden="true"></i></a>
      ...
      <div class="card1">
        <img class="img-fluid" src="images/dairy producs.jpg" alt="Bride">
        <h3 class="title"> Dairy Products</h3>
        <div class="social-links">
          <a class="btn btn-link" href="#"><i class="fab fa-facebook-f" aria-hidden="true"></i></a>
          <a class="btn btn-link" href="#"><i class="fab fa-twitter" aria-hidden="true"></i></a>
          <a class="btn btn-link" href="#"><i class="fab fa-google-plus-g" aria-hidden="true"></i></a>
